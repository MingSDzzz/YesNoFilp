...
当前 Android 版本：`1.3.6`（`versionCode 12`）。
...
- `Tools/Decision Disc/Build APK`：检查 Android Build Support、SDK、NDK 和 OpenJDK，然后构建带版本号的 APK，例如 `Builds/YesNoFilp-v1.3.6.apk`。
